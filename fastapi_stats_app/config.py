...
RATE_LIMIT_SCHEDULE_DATA = RateLimitSettings(
    limit=_read_int_env("FASTAPI_RATE_LIMIT_SCHEDULE_DATA_LIMIT", 120, minimum=0),
    window_seconds=_read_int_env("FASTAPI_RATE_LIMIT_SCHEDULE_DATA_WINDOW_SECONDS", 60),
)
